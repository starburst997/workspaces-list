...
export class IconRenderer {
	...
	): Promise<vscode.ThemeIcon | vscode.Uri | { light: vscode.Uri; dark: vscode.Uri } | undefined> {
		if (!iconConfig) {
			// Default icon
	 ...
	 */
	private resolveIconPath(iconPath: string, workspacePath: string): vscode.Uri | undefined {
		try {
